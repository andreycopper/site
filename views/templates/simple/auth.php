<div class="row align-items-center align-content-center py-md-5 py-4">
    ...
    <form action="/auth/login/" method="post" id="auth">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="login" id="login" class="form-control" placeholder="Enter username" value="andrew">
        </div>
